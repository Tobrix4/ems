                    ...
                    <form action="" id="message-form">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <small class="px-3 text-muted">Celé jméno</small>
                            </div>
                            <div class="col-md-6">
                                ...
                                <small class="px-3 text-muted">Telefonní èíslo</small>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <input type="text" class="form-control form-control-sm form-control-border" id="email" name="email" required placeholder="xxxxxx@xxxxxx.xxx">
                                <small class="px-3 text-muted">Email (discord)</small>
                            </div>
                        </div>
                        <div class="row">
