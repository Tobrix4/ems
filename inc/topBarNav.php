      ...
      <nav class="main-header navbar navbar-expand navbar-dark border-0 text-sm bg-gradient-lightblue" id='top-Nav'>
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse order-3" id="navbarCollapse">
            ...
            <ul class="navbar-nav">
              <li class="nav-item">
                <a href="./" class="nav-link <?= isset($page) && $page =='home' ? "active" : "" ?>">Domů</a>
              </li>
              <li class="nav-item">
                <a href="./?page=search_record" class="nav-link <?= isset($page) && $page =='search_record' ? "active" : "" ?>">Hledat svůj záznam</a>
              </li>
              <li class="nav-item">
                <a href="./?page=about" class="nav-link <?= isset($page) && $page =='about' ? "active" : "" ?>">O Nás</a>
              </li>
              <li class="nav-item">
                <a href="./?page=contact_us" class="nav-link <?= isset($page) && $page =='contact_us' ? "active" : "" ?>">Kontaktovat nemocnici</a>
              </li>
              <!-- <li class="nav-item">
